...
TD 软件可在 [安路科技官网的这个页面](https://www.anlogic.com/support/tools-downloads) 下载，也可在 [这个百度网盘链接](https://pan.baidu.com/s/1n4aupYAuMeOys3RiGdGmtQ?pwd=VMAL) 下载。目前推荐选择 5.6.x 版本，早期版本可能缺少驱动程序。  
